/* Write a program to show details of 10 products including Product Name, Product
Price, Qty to user and provide them ability to make order with qty and show final
amount of bill. */
